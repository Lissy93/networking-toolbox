...
export const SUB_NAV: Record<string, (NavItem | NavGroup)[]> = {
  ...
  '/cidr': [
    ...
    },
    {
      ...
      icon: 'sliders',
      keywords: ['range', 'cidr', 'convert', 'converter', 'ip', 'start', 'end', 'blocks', 'firewall', 'acl'],
    },
    {
  ...
  '/dhcp': [
    {
      href: makePath('/dhcp/option-43'),
      label: 'Option 43 Generator',
    ...
    {
      href: makePath('/dhcp/option-60-builder'),
      label: 'Option 60 Builder',
      description:
    ...
    {
      href: makePath('/dhcp/options/option82-builder'),
      label: 'Option 82 Builder',
      description:
        'Construct and parse DHCP Relay Agent Information (Option 82) with Circuit-ID, Remote-ID, and VLAN formats',
      icon: 'tools',
      keywords: [
        'dhcp',
        'option',
    ...
    {
      href: makePath('/dhcp/options/option119-domain-search'),
    ...
    {
      href: makePath('/dhcp/options/option121-classless-routes'),
    ...
    {
      href: makePath('/dhcp/options/option150-tftp'),
    ...
    {
      href: makePath('/dhcp/options/pxe-profile'),
      label: 'PXE Profile Generator',
      description:
    ...
    {
      href: makePath('/dhcp/options/freeform-tlv'),
    ...
    {
      href: makePath('/dhcp/v6/options/dns-search-rfc3646'),
      label: 'DHCPv6 Options 23/24 - DNS',
      description: 'Configure DNS servers (Option 23) and search domains (Option 24) for DHCPv6 clients per RFC 3646',
      icon: 'globe',
      keywords: [
        'dhcpv6',
        'dhcp',
    ...
    {
      href: makePath('/dhcp/identity/duid-generator'),
    ...
    {
      href: makePath('/dhcp/identity/iaid-calculator'),
    ...
    {
      href: makePath('/dhcp/identity/clientid-option61'),
      label: 'Client ID (Option 61)',
      description:
        'Build and decode DHCPv4 Client Identifier (Option 61): hardware type + MAC address or arbitrary opaque data per RFC 2132',
      icon: 'id-card',
      keywords: [
        'dhcp',
        'dhcpv4',
