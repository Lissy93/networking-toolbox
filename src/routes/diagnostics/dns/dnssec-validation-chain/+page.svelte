<script lang="ts">
  ...
  const examples = [
    { domain: 'gov.uk', description: t('diagnostics/dns-dnssec-validation-chain.examples.items.govuk.description') },
    {
    ...
    { domain: 'isc.org', description: t('diagnostics/dns-dnssec-validation-chain.examples.items.isc.description') },
    { domain: 'ietf.org', description: t('diagnostics/dns-dnssec-validation-chain.examples.items.ietf.description') },
  ];
      ...
      <div class="examples-grid">
        {#each examples as example, i (i)}
          <button
            ...
            use:tooltip={t('diagnostics/dns-dnssec-validation-chain.examples.items.govuk.tooltip').replace(
              'gov.uk',
              example.domain,
            )}
          >
        ...
        <div class="card summary-section" class:valid={results.valid} class:invalid={!results.valid}>
          ...
          <div class="card-content">
            <div class="info-grid">
              ...
              <div class="info-item">
                <span class="info-label">{t('diagnostics/dns-dnssec-validation-chain.results.summary.chainLinks')}</span
                >
