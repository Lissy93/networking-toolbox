<script lang="ts">
  ...
  const examples = [
    { domain: 'example.com', description: t('diagnostics/rdap-domain.examples.items.example.description') },
    { domain: 'google.com', description: t('diagnostics/rdap-domain.examples.items.google.description') },
    { domain: 'github.com', description: t('diagnostics/rdap-domain.examples.items.github.description') },
    { domain: 'stackoverflow.com', description: t('diagnostics/rdap-domain.examples.items.stackoverflow.description') },
    { domain: 'cloudflare.com', description: t('diagnostics/rdap-domain.examples.items.cloudflare.description') },
    { domain: 'iana.org', description: t('diagnostics/rdap-domain.examples.items.iana.description') },
  ];
              ...
              <div class="contacts-grid">
                {#each results.data.contacts as contact, index (index)}
                  <div class="contact-card">
                    ...
                    {#if contact.handle}
                      <p>
                        <small>{t('diagnostics/rdap-domain.results.contacts.handle', { handle: contact.handle })}</small
                        >
                      </p>
                    {/if}
                  </div>
