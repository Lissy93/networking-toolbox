<script lang="ts">
  ...
  const examplesList = [
    {
      ...
      tooltip: $t('diagnostics/tls-banner.examples.items.nmapSSH.tooltip'),
    },
    {
      ...
      tooltip: $t('diagnostics/tls-banner.examples.items.rebexFTP.tooltip'),
    },
    {
      ...
      tooltip: $t('diagnostics/tls-banner.examples.items.exampleHTTP.tooltip'),
    },
    {
      ...
      tooltip: $t('diagnostics/tls-banner.examples.items.googleHTTP.tooltip'),
    },
    {
      ...
      tooltip: $t('diagnostics/tls-banner.examples.items.googleMX.tooltip'),
    },
    {
      ...
      tooltip: $t('diagnostics/tls-banner.examples.items.ianaWHOIS.tooltip'),
    },
    {
      ...
      tooltip: $t('diagnostics/tls-banner.examples.items.freebsdFTP.tooltip'),
    },
    {
      ...
      tooltip: $t('diagnostics/tls-banner.examples.items.httpbinAPI.tooltip'),
    },
    {
      ...
      tooltip: $t('diagnostics/tls-banner.examples.items.verisignWHOIS.tooltip'),
    },
  ];
  ...
  async function grabBanner() {
    ...
    try {
      ...
      diagnosticState.setError(err instanceof Error ? err.message : $t('diagnostics/tls-banner.error.unexpected'));
    }
  }
    ...
    <div class="card-content">
      <div class="form-row">
        <div class="form-group">
          <label for="service">{$t('diagnostics/tls-banner.form.serviceTypeLabel')}</label>
          <select
            id="service"
            bind:value={service}
      ...
      <div class="form-row">
        <div class="form-group flex-2">
          <label for="host">{$t('diagnostics/tls-banner.form.hostLabel')}</label>
          <input
            id="host"
            type="text"
            bind:value={host}
        ...
        <div class="form-group flex-1">
          <label for="port">{$t('diagnostics/tls-banner.form.portLabel')}</label>
          <input
            id="port"
            type="number"
            bind:value={port}
      ...
      <button onclick={grabBanner} disabled={diagnosticState.loading || !isInputValid} class="primary">
        {#if diagnosticState.loading}
          ...
          {$t('diagnostics/tls-banner.form.connecting')}
        {:else}
    ...
    <div class="card results-card">
      ...
      <div class="card-content">
            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                ...
                <span class="info-value">
                  ...
                  {diagnosticState.results.protocol ||
                    $t('diagnostics/tls-banner.results.connectionDetails.protocolUnknown')}
                </span>
              </div>
              <div class="info-item">
        ...
        <div class="card banner-section">
          <div class="card-header">
            <h3>{$t('diagnostics/tls-banner.results.serviceBanner.title')}</h3>
          </div>
          <div class="card-content">
            ...
            {:else}
              <div class="no-banner">
                ...
                <p>{$t('diagnostics/tls-banner.results.serviceBanner.noBannerReceived')}</p>
                <small>{$t('diagnostics/tls-banner.results.serviceBanner.noBannerHint')}</small>
              </div>
            {/if}
          </div>
        </div>
        ...
        {#if diagnosticState.results.analysis && (diagnosticState.results.analysis.software || diagnosticState.results.analysis.version || diagnosticState.results.analysis.os || (diagnosticState.results.analysis.security && diagnosticState.results.analysis.security.length > 0))}
          <div class="card analysis-section">
            <div class="card-header">
              <h3>{$t('diagnostics/tls-banner.results.serviceAnalysis.title')}</h3>
            </div>
            <div class="card-content">
              <div class="analysis-grid">
                {#if diagnosticState.results.analysis.software}
                  <div class="analysis-item">
                    ...
                    <div>
                      <h4>{$t('diagnostics/tls-banner.results.serviceAnalysis.software')}</h4>
                ...
                {#if diagnosticState.results.analysis.version}
                  <div class="analysis-item">
                    ...
                    <div>
                      <h4>{$t('diagnostics/tls-banner.results.serviceAnalysis.version')}</h4>
                ...
                {#if diagnosticState.results.analysis.os}
                  <div class="analysis-item">
                    ...
                    <div>
                      <h4>{$t('diagnostics/tls-banner.results.serviceAnalysis.os')}</h4>
                ...
                {#if diagnosticState.results.analysis.security && diagnosticState.results.analysis.security.length > 0}
                  <div class="analysis-item full-width">
                    ...
                    <div>
                      <h4>{$t('diagnostics/tls-banner.results.serviceAnalysis.securityNotes')}</h4>
                      <ul>
        ...
        {#if diagnosticState.results.tls}
          <div class="card tls-section">
            <div class="card-header">
              <h3>{$t('diagnostics/tls-banner.results.tlsInformation.title')}</h3>
            </div>
            <div class="card-content">
              <div class="tls-info">
                <div class="tls-item">
                  <span class="tls-label">{$t('diagnostics/tls-banner.results.tlsInformation.protocol')}</span>
                  <span class="tls-value">{diagnosticState.results.tls.protocol}</span>
                </div>
                <div class="tls-item">
                  <span class="tls-label">{$t('diagnostics/tls-banner.results.tlsInformation.cipher')}</span>
                  <span class="tls-value">{diagnosticState.results.tls.cipher}</span>
                </div>
                {#if diagnosticState.results.tls.certificate}
                  <div class="tls-item">
                    <span class="tls-label">{$t('diagnostics/tls-banner.results.tlsInformation.certificateCN')}</span>
